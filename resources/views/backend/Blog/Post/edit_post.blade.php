                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        @error('post_image')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <img src="{{asset($blogPost->post_image)}}" style="width: 60px; height: 60px;" id="mainThmb">
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                        </div> <!-- end 6th row  -->
                                        <div class="row"> <!-- start 8th row  -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" name="post_details_ar" rows="10" cols="80">{!!$blogPost->post_details_ar!!}</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                        </div> <!-- end 8th row  -->
