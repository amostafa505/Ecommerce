                                        ...
                                        <div class="row"> <!-- start 8th row  -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor1" name="post_details_en" rows="10" cols="80" required="">Post Details English</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" name="post_details_ar" rows="10" cols="80">Post Details Arabic</textarea>
                                                    </div>
                                                </div>
                                            </div> <!-- end col md 6 -->
                                        </div> <!-- end 8th row  -->
