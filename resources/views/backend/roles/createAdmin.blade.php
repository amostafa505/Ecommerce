...
<div class="col-md-4">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_7" name="shippingarea" value="1">
				<label for="checkbox_7">Shipping area</label>
			</fieldset>
			<fieldset>
			...
			<fieldset>
				<input type="checkbox" id="checkbox_9" name="site" value="1">
...
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_14" name="report" value="1">
				<label for="checkbox_14">Reports</label>
			</fieldset>

			<fieldset>
				<input type="checkbox" id="checkbox_15" name="allusers" value="1">
