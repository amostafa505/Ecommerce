...
@php
	$day = date('d-m-y');
	$today = App\Models\Order::where('order_date',$day)->sum('amount');
	$month = date('F');
            ...
            <div class="col-xl-3 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">This Month Sale's </p>
            ...
            <div class="col-xl-3 col-6">
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            <p class="text-mute mt-20 mb-0 font-size-16">This Year Sale's </p>
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">{{ count($orders) }} <small class="text-success"><i class="fa fa-caret-up"></i> Order </small></h3>
                        </div>
                    </div>
                </div>
            </div>
