...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>AMI Online Shop</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               AMI Online Shop Head Office
               Email:support@amishop.com <br>
               Mob: 01223609881 <br>
               14 Omar elMokhtar St <br>
    ...
    <table width="100%">
        ...
        <tbody>
            ...
            <tr class="font">
                <td align="center">
                    <img src="{{public_path('/uploads/products/thambnails/'.$item->product->product_thambnail)}}" height="60px;" width="60px;" alt="">
                </td>
                <td align="center">{{$item->product->product_name_en}}</td>
                <td align="center">

                </td>
                <td align="center">{{$item->product->color}}</td>
