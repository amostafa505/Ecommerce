<div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
    ...
    <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
        @php
            $hotdeals = App\Models\Product::where('hot_deals' , 1)->where('status' , 1)->orderBy('id' , 'DESC')->limit(3)->get();
        @endphp
        @foreach($hotdeals as $product)
        <div class="item">
            <div class="products">
                <div class="hot-deal-wrapper">
                    <div class="image"> <img src="{{asset('/uploads/products/thambnails/'.$product->product_thambnail)}}" alt="">
                    </div>
